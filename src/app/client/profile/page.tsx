    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white flex items-center gap-3">
          <User className="h-8 w-8 text-[#8A929B]" /> Mi Perfil
        </h1>
      ...
      <Card className="border-rose-100 dark:border-rose-900/30">
        <CardHeader className="bg-[#F5F2EC] dark:bg-[#1A1A14]/20 border-b">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <span className="font-medium text-base">
                ...
                {profile?.birth_date && <span className="text-[#1A1A14] font-semibold ml-1">({calculateAge(profile.birth_date)} años)</span>}
              </span>
            </div>
          </div>
          <div className="flex gap-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg flex items-center gap-2">
            <Syringe className="h-5 w-5 text-slate-500" /> Procedimientos Estéticos Previos
          </CardTitle>
        </CardHeader>
        <CardContent>

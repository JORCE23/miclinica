        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="group/profile flex items-center gap-2.5 hover:bg-muted py-1 pl-1 pr-2.5 rounded-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/20">
            {profile?.avatar_url ? (
              ...
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#54707F] to-[#6E8A98] flex items-center justify-center text-sm font-bold text-white ring-2 ring-white shadow-soft">
          ...
          <DropdownMenuContent align="end" className="w-60 p-0 overflow-hidden">
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-muted/30">
              {profile?.avatar_url ? (
                ...
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#54707F] to-[#6E8A98] flex items-center justify-center text-sm font-bold text-white">
                  {profile?.full_name?.charAt(0)?.toUpperCase() || "U"}
                </div>
              )}
              <div className="min-w-0">

...
const WELCOME: Msg = {
  role: "assistant",
  content: "¡Hola! Soy tu Copilot ✨. Puedo ayudarte a usar Medique, agendar citas, buscar pacientes o redactar mensajes. ¿En qué te ayudo?",
}
...
export function Copilot() {
  ...
  // Dictado por voz: grabar → transcribir (Whisper/Groq) → texto en el input (para revisar y enviar)
          ...
          <div className="p-3 border-t border-border bg-card shrink-0">
            <div className="flex items-end gap-2">
              <textarea
                ...
                rows={1}
                placeholder={recording ? "Grabando… toca ■ para transcribir" : transcribing ? "Transcribiendo…" : "Escribe o usa el micrófono…"}
              ...
              <button
                ...
                title={recording ? "Detener y transcribir" : "Hablar (dictar)"}
              >
